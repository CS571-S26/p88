...
function MiniBarChart({ data, valueFormatter, color = '#4f86f7' }) {
    ...
    <div className="d-flex flex-column align-items-center">
      ...
      >
        ...
        <OverlayTrigger
          ...
          overlay={
            <Tooltip>
              A heuristic score based on focused time, throughput, estimate
              accuracy, and context switch latency.
            </Tooltip>
          }
        >
          <span
  ...
  <div className="d-flex justify-content-end">
    <ButtonGroup>
      {[3, 5, 7].map(days => (
        <Button
          key={days}
          variant={rangeDays === days ? 'primary' : 'outline-primary'}
